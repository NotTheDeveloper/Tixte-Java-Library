...
public enum TimeFormat
{
    ...
    TimeFormat(@NotNull String style)
    {
        this.style = style;
    }
     ...
     *
     * @return The representative {@link TimeFormat} or {@link #DEFAULT} if none could be identified.
     */
    @NotNull
     ...
     * @throws DateTimeException If the temporal accessor cannot be converted to an instant.
     *
     ...
     *
     * @param timestamp The millisecond epoch.
     *
     * @return The markdown string with this encoded style.
     */
    @NotNull
     ...
     *
     * @param instant The {@link Instant} for the timestamp.
     *
